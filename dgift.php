...
$ccart1=mysqli_query($con,"select count(*) from cart where userid=$uid and status='yes'") or die("count cart");
...
$cart1=mysqli_query($con,"select * from cart where userid=$uid and `status`='yes'") or die("cart");
for($i=0;$i<$ccart[0];$i++)
{
