...
if($h!='0')
{
$rec=mysqli_query($con,"select count(*) from product where companyid='$h';");
$prd=mysqli_query($con,"select * from product where companyid='$h';");
}
else
{
$rec=mysqli_query($con,"select count(*) from product;");
$prd=mysqli_query($con,"select * from product;");
}
...
echo "<a href='productinfo.php?t1=$prd1[0]'>";
